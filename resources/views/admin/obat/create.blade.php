                    ...
                    <form class="form-horizontal">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select type="email" class="form-control" id="inputEmail3" placeholder="Email">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select type="password" class="form-control" id="inputPassword3" placeholder="Password">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="password" class="form-control" id="inputPassword3" placeholder="Nama Obat">
                                </div>
                            </div>
                        </div>
                        <!-- /.box-body -->
